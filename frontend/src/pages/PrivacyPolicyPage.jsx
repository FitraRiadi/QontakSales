      ...
      <Container maxW="4xl" py={12}>
        <VStack align="stretch" gap={8}>
          <VStack align="start" gap={2}>
            <Heading fontWeight="semibold" size="xl">Privacy Policy</Heading>
            <Text color="foreground" opacity={0.5}>Last updated: August 31, 2026</Text>
          </VStack>

          <VStack align="stretch" gap={6}>
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>1. Information We Collect</Heading>
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>2. How We Use Your Information</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>3. Data Security</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>4. Data Sharing</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>5. Your Rights</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>6. Contact Us</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
