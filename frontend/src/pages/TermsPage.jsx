      ...
      <Container maxW="4xl" py={12}>
        <VStack align="stretch" gap={8}>
          <VStack align="start" gap={2}>
            <Heading fontWeight="semibold" size="xl">Terms of Service</Heading>
            <Text color="foreground" opacity={0.5}>Last updated: August 31, 2026</Text>
          </VStack>

          <VStack align="stretch" gap={6}>
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>1. Acceptance of Terms</Heading>
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>2. Account Registration</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>3. Acceptable Use</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>4. Payment & Billing</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>5. Intellectual Property</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>6. Limitation of Liability</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>7. Termination</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
            ...
            <Box>
              <Heading fontWeight="semibold" size="md" mb={2}>8. Contact</Heading>
              <Text color="foreground" opacity={0.7} fontSize="sm" lineHeight="tall">
