...
const Topography = ({
  ...
  useEffect(() => {
    ...
    if (!container || !webgl2Supported()) return;
    ...
    const setSize = () => {
      // Pakai clientWidth/Height (layout box murni) BUKAN getBoundingClientRect,
      // karena rect ngikutin transform parent (mis. kartu CTA start di scale 0.98
      // pas entrance) sehingga canvas kekecilan di kanan + bawah.
